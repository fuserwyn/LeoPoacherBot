...
const defaultWelcome = (): Msg[] => [
  {
    ...
    time: Date.now(),
    text:
      "Как в личке с ботом: ИИ отвечает на любой текст, есть #training_done и /start. Переписка здесь не дублируется в Telegram; ответы Лео остаются здесь. «Стая» — чужие отчёты.",
  },
];
