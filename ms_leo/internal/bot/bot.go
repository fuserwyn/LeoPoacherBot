...
• /cups — Твои заработанные кубки
• /help — Эта справка

💪 Тренировки:
• Отчёт — через мини-апп (кнопка «+»)
• За каждую тренировку = 1 кубок
• Стрик 7 дней = 42 кубка, 30 дней = 420 кубков и т.д.

🏥 Больничный:
• #sick_leave — приостанавливает таймер
• #healthy — возобновляет таймер

⏰ Правила:
• 6 дней без отчёта — предупреждение
• 7 дней без отчёта — удаление из чата
